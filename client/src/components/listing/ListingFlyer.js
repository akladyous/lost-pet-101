        ...
        >
            ...
            >
                <div
                    ...
                    style={{border: "1px solid var(--orange)",height: "150px",borderRadius: "25px",}}
                >
                    <h1 className="text-center font-orange" style={{ fontSize: "80px" }}>
                ...
                <div className="row my-4 p-2  d-flex flex-column justify-content-center">
                    <div
                        className="container"
                        style={{height: "300px", border: "1px solid var(--orange)",borderRadius: "25px",}}
                    >
                        <div className="container mt-2">
                            <h3 className="text-center fs-1 font-orange">DESCRIPTION</h3>
