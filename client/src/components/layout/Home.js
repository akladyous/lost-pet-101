                            ...
                            >
                                ...
                                <div className="card-body ">
                                    ...
                                    <p className="card-text">
                                        Speak with neighbors, postal carriers
                                        and landscapers about your missing pet.
                                        Put your lost pet flyer in local vet
                        ...
                        <div className="col-6 col-md-4 mt-5">
                            ...
                            >
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">Card title</h5>
                                    <p className="card-text">
                                        Upload a picture of your lost pet,
                                        search the Petco Love Lost database,
                                        then sign up to receive alerts about
                                        your pet and create a lost pet flyer.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-6 col-md-4 mt-5">
                            ...
                            >
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">Card title</h5>
                                    <p className="card-text">
                                        While most shelters are listing found
                                        pets on Petco Love Lost, we cannot
                                        guarantee that every shelter in your
                                        area participates.
                                    </p>
                                </div>
                            </div>
